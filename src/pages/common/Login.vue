  ...
  <div class="login_body">
    <div class="login">
      <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
        <div class="logo">
<!--          <img style="width: 60px" src="@/assets/images/logo-1.png">-->
...
<!--            <svg-icon slot="prefix" icon-class="validCode" class="el-input__icon input-icon" />-->
        ...
        <el-form-item style="width:100%;">
          ...
          <div style="float: right;" v-if="register">
            <router-link class="link-type" :to="'/website/Register'">立即注册</router-link>
          </div>
        </el-form-item>
      </el-form>
      <!--  底部  -->
    ...
    handleLogin() {
      this.$refs.loginForm.validate(valid => {
        if (valid) {
          ...
          login(this.loginForm.username,this.loginForm.password,this.loginForm.code,this.loginForm.uuid).then(response => {
