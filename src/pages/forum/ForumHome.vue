<template>
  <div class="forum-container">
    ...
    <el-pagination class="pagination" layout="prev, pager, next" background :total="articleTotal"
      :page.sync="articleQueryParams.pageNum" :limit.sync="articleQueryParams.pageSize"
      @current-change="getArticleListPage" @pagination="getArticleList">
    </el-pagination>
  </div>
</template>
